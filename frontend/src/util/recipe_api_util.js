...
export const getRandomRecipe = (number = 1, tags) => {
  ...
  return axios.get(`https://api.spoonacular.com/recipes/random?number=${number}&tags=${tagStr}&apiKey=${key.apiKey}`);
...
export const getRandomRecipes = (number) => {
  return axios.get(`https://api.spoonacular.com/recipes/random?number=${number}&apiKey=${key.apiKey}`);
  // return axios({
  //   "method": "GET",
  //   "url": "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/random",
  //   "headers": {
...
export const getRecipeById = (id, includeNutrition = true) => {
  return axios.get(`https://api.spoonacular.com/recipes/random?id=${id}&includeNutrition=${includeNutrition}&apiKey=${key.apiKey}`);
...
export const getMultipleRecipes = (ids, includeNutrition = true) => {
  ...
  return axios.get(`https://api.spoonacular.com/recipes/informationBulk?ids=${idString}&includeNutrition=${includeNutrition}&apiKey=${key.apiKey}`);
...
export const getRecipesByIngredients = (ingredients, limit = 12, ranking = 1, ignorePantry = true) => {
  ...
  return axios.get(`https://api.spoonacular.com/recipes/findByIngredients?ingredients=${query}&ranking=${ranking}&ignorePantry=${ignorePantry}&number=${limit}&apiKey=${key.apiKey}`);
    // .then((response) => {
    //   debugger
...
export const searchRecipeByName = (name, limit = 5) => {
  return axios.get(`https://api.spoonacular.com/recipes/autocomplete?query=${name}&number=${limit}&apiKey=${key.apiKey}`);
...
export const getSimilarRecipes = (id, limit = 5) => {
  return axios.get(`https://api.spoonacular.com/recipes/${id}/similar?number=${limit}&apiKey=${key.apiKey}`);
  // axios({
  //   "method": "GET",
...
export const extractRecipe = (url) => {
  return axios.get(`https://api.spoonacular.com/recipes/extract?url=${url}&apiKey=${key.apiKey}`);
  // return axios({
  //   "method": "GET",
