...
class WeeklyNutrition extends React.Component {
  ...
  generateNutrientTableRows() {
    ...
    for (let i = 0; i < main.length; i++) {
      ...
      nutritionRows.push(
        <div className="weekly-nutrient-row" key={`main-${i}`}>
      ...
      if (i !== main.length - 1) {
        nutritionRows.push(<div className="nutrition-divider" key={`divider-main-${i}`}></div>);
      }
    }

    nutritionRows.push(<div className="nutrition-section-divider" key="section-divider" />);
    ...
    for (let i = 0; i < elements.length; i++) {
      ...
      nutritionRows.push(
        <div className="weekly-nutrient-row" key={`element-${i}`}>
          <div className="weekly-nutrient-name">
      ...
      if (i !== elements.length - 1) {
        nutritionRows.push(<div className="nutrition-divider" key={`divider-element-${i}`}></div>);
      }
    }
